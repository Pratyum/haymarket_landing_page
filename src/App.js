              ...
              <div className="row bm-notes">
                <div className="col-md-4">
                  ...
                  >
                    ...
                    <p>
                      From this page you can access services provided by our HR
                      Services partner, Black Mountain.
                    </p>
                  </div>
                </div>
                <div className="col-md-4">
                  ...
                  >
                    ...
                    <p>
                      For HR Self Service tasks, such as applying for leave,
                      amending your address or checking your emergency contacts,
                      use the “HR Self-Service” link below to access the new
                      “Zoho People” system.
                    </p>
                  </div>
                </div>
                <div className="col-md-4">
                  ...
                  >
                    ...
                    <p>
                      To request approval for business travel or submit
                      expenses, please access the “Travel & Expenses” link
                      below, which will take you to the new “Zoho Expense” tool.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="row bm-notes" style={{ paddingTop: 10 }}>
                ...
                <div className="col-12 col-md-12 no-gutters no-padding">
                  ...
                  >
                    ...
                    <p>
                      You can contact the Black Mountain team directly for help
                      on these tools, or for any routine HR enquiries:
                    </p>
                    <p>
                      Singapore: Contact Faith Chan,
                      faith.chan@blackmountainhr.com
                      <br />
                      Hong Kong: Contact Claire Loh,
                      Claire.loh@blackmountainhr.com
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="col-md-6">
              <div className="row">
                <div className="col-md-12" style={{ paddingRight: 0 }}>
                  <div
                    style={{ padding: "0px 0 0px", backgroundColor: "#89bcf1" }}
                  >
